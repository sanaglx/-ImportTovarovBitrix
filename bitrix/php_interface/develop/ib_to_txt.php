...
/**
 * ВНИМАНИЕ ПЕРЕНЕС ЭТОТ КЛАСС В МОДУЛЬ
 * ОТВЯЗАЛ ОТ ИНИТА
 * БОЛЬШЕ НЕ ИСПОЛЬЗУЮ ОСТАВИЛ КАК АРХИВ
       ...
       // while ($rs = $res24->GetNext()):
            ...
            if ($tp) {
                ...
                if (is_array($arInfo)) {
                    ...
                    $html .="<tr><td ><a target='_blank' href='/bitrix/admin/iblock_element_edit.php?IBLOCK_ID=" 
                            . $id_blok . "&type=catalog&ID=" . $id_tov . "&lang=ru'>" 
                            . $nn['NAME'] . "</a></td><td colspan='3' style='background:#ffc;' ><a href=\"https://yandex.ru/search/?lr=213&text=$nn[NAME]\" target=\"_blank\"><img src=\"6165654.png\" width=\"15px;\"></a></td></tr>";
